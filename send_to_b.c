...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/02 18:40:36 by zchtaibi          #+#    #+#             */
/*   Updated: 2024/06/02 18:40:37 by zchtaibi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	send_to_stack_b(t_stack_data *stack_a, t_stack_data *stack_b)
{
	...
	{
		if (stack_b->size >= 2 && stack_b->head->index < pivot2
			&& stack_b->head->index > rem && stack_a->head->index > pivot1)
			rr(stack_a, stack_b);
		else if (stack_b->size >= 2 && stack_b->head->index < pivot2
			&& stack_b->head->index > rem)
			rb(stack_b);
